...
<body>
    ...
    <input type="text" id="jibunAddress" name="jibunAddress" placeholder="지번 주소" style="display: none;">
...
<div class="map_wrap">
    <div id="map" style="width:750px;height:700px;position:relative;overflow:hidden;"></div>
    <div class="hAddr">
...
<script type="text/javascript" src="//dapi.kakao.com/v2/maps/sdk.js?appkey=73f10e0ecb2825848d7a1578ec6ca978&libraries=services,clusterer,drawing"></script>
<script>
            ...
            if (result[i].region_type === 'H') {
                ...
                searchDetailAddrFromCoords(map.getCenter(), function (result, status) {
                    if (status === kakao.maps.services.Status.OK) {
                        ...
                        var jibunShortAddr = jibunAddr.split(' ').slice(0, 2).join(' '); // 지번 주소 (ex. 서울 중구)
